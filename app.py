...
# smptplib
# to post to email, you'll have to post to server, then using a piece of python code, post to smtp server, which will send to email
...
def fball():
	...
	return render_template("football.html", seasons=seasons)
